...
namespace Cinemachine
{
    ...
    [AddComponentMenu("Cinemachine/Brain")]
    public class CinemachineBrain : MonoBehaviour
    {
        ...
        public Vector3 DefaultWorldUp { get { return (m_WorldUp != null) ? m_WorldUp.transform.up : Vector3.up; } }
        ...
        private IEnumerator AfterPhysics()
        {
            ...
            if (m_UpdateMethod == UpdateMethod.SmartUpdate)
            {
                ...
                UpdateVirtualCameras(CinemachineCore.UpdateFilter.Fixed, GetEffectiveDeltaTime());
            }
            else 
            {
                ...
                {
                    AddSubframe(); // FixedUpdate can be called multiple times per frame
                    UpdateVirtualCameras(CinemachineCore.UpdateFilter.Any, GetEffectiveDeltaTime());
                }
            }
        }
        ...
        private void OnPreCull()
        {
            if (!Application.isPlaying)
            {
                ...
                float deltaTime = GetEffectiveDeltaTime();
                UpdateVirtualCameras(CinemachineCore.UpdateFilter.Any, deltaTime);
                ProcessActiveCamera(deltaTime * GetSubframeCount());
            }
        }
#endif
