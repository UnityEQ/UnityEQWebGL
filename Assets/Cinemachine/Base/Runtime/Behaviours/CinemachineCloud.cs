...
{
    /// <summary>
    /// Cinemachine Cloud allows the user to specify a group or collection 
    /// of <see cref="CinemachineVirtualCameraBase"/>s which dynamically frame an event, or subject.
    /// When the cloud is enabled, it will iterate through its list 
    ...
    [AddComponentMenu("Cinemachine/Cloud")]
    public class CinemachineCloud : CinemachineVirtualCameraBase
    {
        ...
        /// if the cloud were active.</summary>
